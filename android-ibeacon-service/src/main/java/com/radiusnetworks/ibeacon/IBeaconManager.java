...
public class IBeaconManager {
	 ...
	 * 
	 * @see com.radiusnetworks.ibeacon.IBeaconManager#setRangeNotifier(RangeNotifier)
	 * @see com.radiusnetworks.ibeacon.IBeaconManager#stopRangingBeaconsInRegion(Region region)
	 * @see RangeNotifier
	 * @see Region
	 * @param region
	 */
	 ...
	 * @see com.radiusnetworks.ibeacon.IBeaconManager#stopMonitoringBeaconsInRegion(Region region)
	 * @see MonitorNotifier
	 * @see Region
	 * @param region
	 */
	 ...
	 * 
	 * @see com.radiusnetworks.ibeacon.IBeaconManager#setMonitorNotifier(MonitorNotifier)
	 * @see com.radiusnetworks.ibeacon.IBeaconManager#startMonitoringBeaconsInRegion(Region region)
	 * @see MonitorNotifier
	 * @see Region
	 * @param region
	 */

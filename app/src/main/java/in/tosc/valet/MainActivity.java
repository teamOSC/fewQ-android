...
public class MainActivity extends FragmentActivity implements
    ...
    public void onConnected(Bundle connectionHint) {
        ...
        String personName = "Umair";
        String email = "omerjerk@gmail.com";
        String phoneNumber = "9971015933";
        ...
        final HttpPost httpPost = new HttpPost("http://tosc.in:8080/user_register");
        List<NameValuePair> pairs = new ArrayList<NameValuePair>();
        pairs.add(new BasicNameValuePair("name", personName));
        pairs.add(new BasicNameValuePair("phone", phoneNumber));
        ...
        Intent loggedInActivity = new Intent(this, LoggedInActivity.class);
